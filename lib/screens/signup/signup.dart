                              ...
                              onTap: () async {
                                if (widget._formKey.currentState!.validate()) {
                                  ...
                                  if (userCredential != null) {
                                    ...
                                    await LocalDb.setUserProfileUid(
                                        userProfileUid);
                                    var res = await FirebaseMethods.createUser(
                                      ...
                                      '${locationServiceProvider
                                          .latitude},${locationServiceProvider
                                          .longitude}',
                                      localityCode: '',
                                      pinCode: '',
                                      password: _passwordController.text,
                                      ipAddress: locationServiceProvider
                                          .ipAddress,
                                      empDesignation: _designationController
                                          .text,
                                      appVersion: '',
                                      deviceType:
